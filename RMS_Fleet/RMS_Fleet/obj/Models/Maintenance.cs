...
namespace RMS_Fleet.Models
{
    public class MaintenanceAttributes
    {
      ...
      public string ReceiptedAmount { get; set; }
      public string PenaltyAmount { get; set; }
      public string NonReceipteAmount { get; set; }
      public string TotalAmount { get; set; }
      public string IssueDate { get; set; }
      public string PolicyNumber { get; set; }
      public string IDVValue { get; set; }
      public string NCBAmount { get; set; }
      public string PremiumAmount { get; set; }
      public string Claim { get; set; }
      public string ClaimNumber { get; set; }
      public string TotalRepairAmt { get; set; }
    ...
    public class Maintenance
    {
        ...
        public DataSet GetMakeModelChessisNumber(int RegionId, int BranchId, string VechileNumber)
        {
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "sharique.aslam@sisprosegur.com", "sharique.aslam@sisprosegur.com", "", "Error Occurred: - GetMakeModelChessisNumber", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
            return ds;
        }
        ...
        public DataSet GetDocumentExpiryDate(int RegionId, int BranchId, string VechileNo, string Document)
        {
            ...
            try
            {
                ...
                sql = "SELECT * FROM Fleet_Maintenance_Tax_Details	WHERE " + 
                      "VehicleNumber=@VehicleNumber and Document=@Document";
        ...
        public DataSet GetMaintenanceDocumentDate(string RegionId, string BranchId, string VechileNo, string document)
        {
            ...
            try
            {
                ...
                sql = " SELECT ExpiryDate,DATEADD(DAY,-4,ExpiryDate) AS OneYearComplete,ReceivingDate, " +
                      " ReceiptedAmount,PenaltyAmount,NonReceipteAmount,TotalAmount,IssueDate,PolicyNumber,IDVValue,NCBAmount,PremiumAmount,Claim,ClaimNumber,TotalRepairAmt,ClaimAmount " +
                      " FROM Fleet_Maintenance_Tax_Details WHERE VehicleNumber=@VechileNo AND Document=@document";
