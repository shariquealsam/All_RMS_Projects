    ...
    public class KPLData
    {
        ...
        public DataSet GetRegionName()
        {
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "", "", "Error Occurred: - GetRegionNameWithoutParameter", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
        ...
        public DataSet GetAllVechileNumber()
        {
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "suraj.kumar@sisprosegur.com", "", "Error Occurred: - GetAllVechileNumber", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
        ...
        public DataSet GetAllMasterDetailsForUser(string VechileNumber)
        {
            ...
            try
            {
                ...
                string sql = " SELECT VehicleNo,StdKmpl,BpNonBp,FuelConsuption, " +
                                ...
                                "  )TblAll   ";
                            //"WHERE VechileNumber=@VechileNumber AND MonthS=@PreviousMonth";
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "suraj.kumar@sisprosegur.com", "", "Error Occurred: - GetAllMasterDetailsForUser", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
            return ds;
        }
        ...
        public DataSet GetOpeningKM_OpeningFuel(string VechileNumber)
        {
            ...
            try
            {
                ...
                string sql = "SELECT VechileNumber,ClosingKM As OpeningKM,ClosingFuelLtr As OpeningFuel,[Month] FROM [dbo].[Fleet_KPL_Branch_Details] WITH(NOLOCK) " +
                            "WHERE rec_id = " +
                            "( " +
                            "select max(rec_id) from [dbo].[Fleet_KPL_Branch_Details] WITH(NOLOCK) " +
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "suraj.kumar@sisprosegur.com", "", "Error Occurred: - GetOpeningKM_OpeningFuel", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
            return ds;
        }
        ...
        public bool CheckVechileNumberExistingOrNot(string VechileNumber)
        {
            ...
            catch (Exception ex)
            {
                ...
                //ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "suraj.kumar@sisprosegur.com", "", "Error Occurred: - CheckVechileNumberExistingOrNot", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
...
//                    ";
            ...
            catch (Exception ex)
            {
                ...
                //ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "suraj.kumar@sisprosegur.com", "", "Error Occurred: - CountDetailsOfVechileByBranch", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
        ...
        public DataSet GetBranchDetailsByVechileNumberOfPreviousMonth(string VechileNumber)
        {
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "suraj.kumar@sisprosegur.com", "", "Error Occurred: - GetBranchDetailsByVechileNumberOfPreviousMonth", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
        ...
        public DataSet GetRouteServiceDetails(string VechileNumber)
        {
            ...
            catch(Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "suraj.kumar@sisprosegur.com", "", "Error Occurred: - GetRouteServiceDetails", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
