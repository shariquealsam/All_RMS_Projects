    ...
    public class SalesReportData
    {
        ...
        public DataSet GetKPLReports(string Year, string Month, int RegionId, int BranchId, string VechileNumber)
        {
            ...
            try
            {
                ...
                SqlConnection con = new SqlConnection(strSqlConnectionString);
                sql = "Fleet_KPL_Get_KPL_Report_By_VechlieNumber";
                SqlCommand cmd = new SqlCommand(sql, con);
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "suraj.kumar@sisprosegur.com", "", "Error Occurred: - GetKPLReports", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
