    ...
    public class LoginDetails
    {
        ...
        public DataSet GetUserNameDetails(string UserId, string password)
        {
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "", "", "Error Occurred: - GetUserNameDetails_FleetApp", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
