    ...
    public class ChangePasswordCode
    {
        ...
        public bool UpdatePassword(string CurrentPassword, string NewPassword, string UserID)
        {
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "", "", "Error Occurred: - UpdatePassword", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
        ...
        public int UpdateChangePassword(string CurrentPassword, string NewPassword, string UserID)
        {
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "shiva.brata@sisprosegur.com", "", "", "Error Occurred: - UpdateChangePassword", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
