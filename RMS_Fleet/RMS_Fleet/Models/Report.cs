...
namespace RMS_Fleet.Models
{
    ...
    public class ReportData
    {
        ...
        public DataSet GetReportMaster(string Date, string RegionId, string FromDate, string ToDate, string RegId, string Branchid, string IsFilter, string IsSessionRegionID, string UserType)
        {
            ...
            try
            {
                ...
                if (IsFilter != "1")
                {
                    ...
                    {
                        //SQL Statement 
                        sSql = "SELECT ROW_NUMBER() OVER(ORDER BY (Select NULL)) As [SrNo],Opn.Report_Date,Opn.Service_Type,Opn.Route_Id," +
                                ...
                                "Opn.Report_Date as OpenDate, Opn.Report_Time As OpnTime,Opn.Remarks As OpnRemarks,Clos.Report_Date as CloseDate,Clos.Report_Time As ClosTime,Clos.Remarks As ClosRemarks " +
                                " FROM (  " +
                                "Select FRD.RegionName,FBD.BranchName,FRED.VehicleNo,FRED.Route_Id,FRED.Service_Type,  " +
                                ...
                                "LEFT JOIN ( Select FRD.RegionName,FBD.BranchName,FRED.VehicleNo,FRED.Route_Id,FRED.Service_Type,  " +
                                ...
                                "ON (Opn.BranchId = Clos.BranchId and Opn.VehicleNo = Clos.VehicleNo AND Opn.OCKey = Clos.OCKey)  " +
                                //"ON (Opn.BranchId = Clos.BranchId and Opn.RegionId = Clos.RegionId and Opn.VehicleNo = Clos.VehicleNo AND Opn.Route_Id = Clos.Route_Id AND Opn.OCKey = Clos.OCKey)  " +
                    ...
                    else
                    {
                        if ((Date != null || Date != "") && (RegionId == null || RegionId == "" || RegionId == "0"))
                        {
                            ...
                            sSql = "SELECT ROW_NUMBER() OVER(ORDER BY (Select NULL)) As [SrNo],Opn.Report_Date,Opn.Service_Type," +
                                    "Opn.Route_Id,Opn.VehicleNo,Opn.BranchName,ISNULL(Opn.OpenClose_KM,0) As OpeningKM, " +
                                    ...
                                    ")Clos ON (Opn.BranchId = Clos.BranchId and Opn.VehicleNo = Clos.VehicleNo AND Opn.OCKey = Clos.OCKey) " +
                                    //")Clos ON (Opn.BranchId = Clos.BranchId and Opn.RegionId = Clos.RegionId and Opn.VehicleNo = Clos.VehicleNo AND Opn.Route_Id = Clos.Route_Id AND Opn.OCKey = Clos.OCKey) " +
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "sharique.aslam@sisprosegur.com", "", "", "Error Occurred: - GetReportMaster", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
        ...
        public DataSet GetOpnClosImageDetails(string OCKey, string VechileNumber)
        {
            ...
            try
            {
                ...
                sSql = "SELECT " +
                        ...
                        "tblfinaldata.Route_Id,OpeningKM, " +
                        "OpeningDate,  " +
                        "OpeningTime,  " +
                        "OpeningImage,  " +
                        ...
                        "Opn.Route_Id,Opn.OpenClose_KM As OpeningKM, " +
                        ...
                        " left join Fleet_Driver_Info driver with(nolock) " +
                         " on tblfinaldata.Route_Id = driver.Route_Id and tblfinaldata.VehicleNo = driver.Vehicle_No and " +
                         " CONVERT(date, tblfinaldata.Created_Datetime) = CONVERT(date, driver.Created_On) ";
            ...
            catch (Exception ex)
            {
                ...
                ci.SendMailMessage("support@sisprosegur.com", "sharique.aslam@sisprosegur.com", "", "", "Error Occurred: - GetOpnClosImageDetails", ex.Message.ToString() + "|" + ex.StackTrace.ToString());
            }
        ...
        public DataSet GetReportRegionVsBranchMaster(string Date, string RegionId, string Branchid)
        {
            ...
            try
            {
                ...
                sSql = "SELECT ROW_NUMBER() OVER(ORDER BY (Select NULL)) As [SrNo],Opn.Report_Date,Opn.Service_Type,Opn.Route_Id," +
                        ...
                        " " +
                        "ON  " +
                        "(Opn.BranchId = Clos.BranchId and Opn.RegionId = Clos.RegionId and Opn.VehicleNo = Clos.VehicleNo AND Opn.Route_Id = Clos.Route_Id AND Opn.OCKey = Clos.OCKey)   " +
                        "WHERE Convert(Date,Opn.Created_Datetime) = '" + Date + "' AND Opn.BranchId = " + Branchid + " ";
        ...
        public DataSet GetNoActivityVehicles(string RegionId, string Type)
        {
            Get_from_config();
            DataSet ds = new DataSet();

                string strSql = "Fleet_NoReportingVehiclesRegionWise";
